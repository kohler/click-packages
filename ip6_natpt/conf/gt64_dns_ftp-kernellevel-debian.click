//File: gt64_dns-ftp-userlevel-universidad.click.
//Date: 18/01/2003
//Author: Juan Luis Baptiste M. <juancho@linuxmail.org>

//Configuration file for an IPv6/IPv4 Address Translator.
...
elementclass GatewayDevice {
  $device |
  from :: FromDevice($device,PROMISC true)
	-> output;
  input -> q :: Queue(1024)
	-> to :: ToDevice($device);
...
intern_dev :: SniffGatewayDevice(eth0);

//Configuration of Neighboor solicitation and advertisement elements for
//comunication with IPv6 hosts.

extern_nda::IP6NDAdvertiser(3ffe:1ce1:2:0:200::1/128 00:60:97:C0:D4:74,
			    3ffe:1ce1:2::/80 00:60:97:C0:D4:74);
extern_nds::IP6NDSolicitor(3ffe:1ce1:2:0:200::1, 00:60:97:C0:D4:74);

//Configuration of ARP elements for comunication with IPv4 hosts.

intern_arp::ARPQuerier(172.25.79.156, 00:50:8B:65:2C:23);
intern_arr::ARPResponder(172.25.79.156 00:50:8B:65:2C:23);
...
//ALG's
dnsAlg:: DNSAlg(at,
		79.25.172.in-addr.arpa,
 		ns.prueba.com,
  		0.0.2.0.0.0.0.0.2.0.0.0.1.E.C.1.E.F.F.3.ip6.int,
		ns6.gt64.org);
...
at[0]  	
//-> Print(antes_de_pt64_0, 200)
	-> [0]pt64;
at[1]  	
-> CheckIP6Header(3ffe:1ce1:2:0:200::ffff 3ffe:1ce1:2::ffff)
//-> IP6Print(contenido6:, CONTENTS true)
//-> Print(antes_de_ftp6_1, 200)
//-> IP6Print(contenidoipv6)
  -> [1]ftp6;
...
//-> IPPrint(contenidoipv4,CONTENTS 'ascii')
->[0]tcpAddr;
...
//->Print(despues_de_ftp6_1,200)
  ->[1]tcpAddr;
tcpAddr[0]
//->Print(antes_de_dnsalg_0,200)
  -> [0]dnsAlg;

tcpAddr[1]
//->Print(antes_de_dnsalg_1,200)
  -> [1]dnsAlg;

dnsAlg[0]
//->Print(despues_de_dnsAlg_0,200)
	-> GetIPAddress(16)
	-> [0]ipv4rt;
dnsAlg[1]
//->Print(despues_de_dnsAlg_1,200)
	-> GetIP6Address(24)
	-> [0]ipv6rt;
